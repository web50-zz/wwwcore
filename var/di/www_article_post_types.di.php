...
/**
*
* @author	Fedot B Pozdnyakov 9@u9.ru 04082013	
* @package	SBIN Diesel
*/
class di_www_article_post_types extends data_interface
{
	public $title = 'www: Статьи - типы постов';
	...
	*/
	protected $name = 'www_article_post_types';
