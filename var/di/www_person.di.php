...
class di_www_person extends data_interface
{
	...
	*/
	protected $name = 'www_person';

	/**
	* @var	string	$path_to_storage	Путь к хранилищу файлов каталога
	*/
	public $path_to_storage = 'filestorage/www_person/';

	/**
	* @var	array	$_preview	Массив с описанием параметров preview-файлов по умолчанию, можно переопределить ключём реестра "www_person"
	*/
	...
	*/
	protected function prepare_preview_params($reg_key = 'www_person')
	{
