ui.banner.banner_grid = Ext.extend(Ext.grid.EditorGridPanel, {
	getPid: function(){
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/banner/list.js',
						create: 'di/banner/set.js',
						update: 'di/banner/mset.js',
						destroy: 'di/banner/unset.js'
					}
				}),
		...
		ui.banner.banner_grid.superclass.constructor.call(this, config);
	},
