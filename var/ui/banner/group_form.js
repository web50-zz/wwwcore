ui.banner.group_form = Ext.extend(Ext.form.FormPanel, {
	Load: function(data){
		var f = this.getForm();
		var id = parseInt(data.id) || 0;
		var pid = parseInt(data.pid) || 0;
		f.load({
			url: 'di/banner_group/get.json',
	...
	constructor: function(config){
		...
		ui.banner.group_form.superclass.constructor.call(this, config);
		this.on({
