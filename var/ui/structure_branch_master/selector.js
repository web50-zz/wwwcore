ui.structure_branch_master.selector = Ext.extend(ui.structure_branch_master.grid, {
	bttAdd: 'Импорт',
	bttEdit: 'Редактировать',
	bttDelete: 'Удалить',
	bttSearch: 'Найти',
	bttCancle: 'Сбросить',
	lblLoad: 'Добавить только потомков',
	lblLoadAll: 'Добавить с замещением ( текущая нода будет изменена )',
	lblLoadRoot: 'Добавить ниже',
	...
	constructor: function(config)
	{
		...
		ui.structure_branch_master.selector.superclass.constructor.call(this, config);
		this.on({
