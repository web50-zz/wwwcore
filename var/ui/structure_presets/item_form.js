ui.structure_presets.item_form = Ext.extend(Ext.form.FormPanel, {
	...
	Load: function(input){
		...
		f.load({
			url: 'di/structure_presets/get.json',
			params:params ,
	...
	Save: function(){
		...
		if (f.isValid()){
			f.submit({
				url: 'di/structure_presets/set.do',
	...
	constructor: function(config){
		...
		ui.structure_presets.item_form.superclass.constructor.call(this, config);
		if(this.pid > 0){
