ui.www_article_file_types.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	clmnTitle: "Название",
	clmnId:"Id",
	pagerSize: 50,
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/www_article_file_types/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/www_article_file_types/list.js',
						create: 'di/www_article_file_types/set.js',
						update: 'di/www_article_file_types/mset.js',
						destroy: 'di/www_article_file_types/unset.js'
					}
				}),
		...
		Ext.apply(this, {
			...
			enableDragDrop: true,
			ddGroup: 'www_article_file_types',
		...
		ui.www_article_file_types.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
