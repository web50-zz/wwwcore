ui.www_article_in_category.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/www_article_in_category/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/www_article_in_category/list.js',
						create: 'di/www_article_in_category/set.js',
						update: 'di/www_article_in_category/mset.js',
						destroy: 'di/www_article_in_category/unset.js'
					}
				}),
		...
		Ext.apply(this, {
			...
			enableDragDrop: true,
			ddGroup: 'www_article_in_category',
		...
		ui.www_article_in_category.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
