...
/**
*
* @author	FedotB Pozdnyakov 9@u9.ru 23072013
* @package	SBIN Diesel
*/
class ui_www_article_in_category extends user_interface
{
	public $title = 'www: Публикации -  публикации в категориях';

	protected $deps = array(
		'main' => array(
			'www_article_in_category.grid',
		),
	);
