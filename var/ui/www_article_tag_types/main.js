ui.www_article_tag_types.main = Ext.extend(ui.www_article_tag_types.grid, {
	bttAdd: "Добавить",
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.www_article_tag_types.form();
		...
		app.Load('www_article_tag_types', 'form');
	},
	Edit: function(){
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('www_article_tag_types')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.www_article_tag_types.main.superclass.constructor.call(this, config);
		this.on({
