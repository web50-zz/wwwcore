ui.www_career.main = function(config){
	var frmW = 700;
	var frmH = 480;
	var fm = Ext.form;
	...
	var proxy = new Ext.data.HttpProxy({
		api: {
			read: 'di/www_career/list.js',
			create: 'di/www_career/set.js',
			update: 'di/www_career/mset.js',
			destroy: 'di/www_career/unset.js'
		}
	});
	...
	var Add = function(){
		var f = new ui.www_career.item_form();
	...
	var Types = function(){
		var f = new ui.www_career_type.main();
	...
	ui.www_career.main.superclass.constructor.call(this, {
		store: store,
		columns: columns,
		loadMask: true,
		...
		tbar: [
			...
			'->', {iconCls: 'help', handler: function(){showHelp('www_career')}}
		],
...
Ext.extend(ui.www_career.main, Ext.grid.EditorGridPanel, {
	limit: 10,

	addTitle: "Добавление",
	editTitle: "Редактирование",
	labelwww_careerTypes: '',
