ui.www_client.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/www_client/list.js',
						create: 'di/www_client/set.js',
						update: 'di/www_client/mset.js',
						destroy: 'di/www_client/unset.js'
					}
				}),
		...
		ui.www_client.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
