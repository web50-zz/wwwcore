ui.www_faq.main = Ext.extend(ui.www_faq.tree, {
	bttAdd: "Ответить",
	...
	constructor: function(config){
		...
		Ext.apply(this, {
			...
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('www_faq_grid')}}
			]
		});
		Ext.apply(this, config);
		ui.www_faq.main.superclass.constructor.call(this, config);
		this.on({
