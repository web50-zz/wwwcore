ui.www_faq.tree = Ext.extend(Ext.tree.TreePanel, {
	reload: function(id){
		if (id){
	...
	constructor: function(config){
		config = config || {};
		Ext.apply(this, {
			loader: new Ext.tree.TreeLoader({url: 'di/www_faq/slice.json'}),
		...
		ui.www_faq.tree.superclass.constructor.call(this, config);
		this.on({
