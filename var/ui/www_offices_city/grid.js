ui.www_offices_city.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	clmnTitle: 'Акция',
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/www_offices_city/list.js',
						create: 'di/www_offices_city/set.js',
						update: 'di/www_offices_city/mset.js',
						destroy: 'di/www_offices_city/unset.js'
					}
				}),
		...
		ui.www_offices_city.grid.superclass.constructor.call(this, config);
	},
