ui.www_offices_city.main = Ext.extend(ui.www_offices_city.grid, {
	titleAdd: 'Создание',
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.www_offices_city.item_form();
		...
		app.Load('www_offices_city', 'item_form');
	},
	Edit: function(){
	...
	constructor: function(config)
	{
		...
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('www_offices_city')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.www_offices_city.main.superclass.constructor.call(this, config);
		this.init();
	},
