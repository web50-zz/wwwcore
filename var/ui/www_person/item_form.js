ui.www_person.item_form = Ext.extend(Ext.form.FormPanel, {
	Load: function(data){
		var f = this.getForm();
		f.load({
			url: 'di/www_person/get.json',
			params: {_sid: data.id},
	...
	constructor: function(config){
		...
		ui.www_person.item_form.superclass.constructor.call(this, config);
		this.on({
