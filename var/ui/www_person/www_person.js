ui.www_person.main = Ext.extend(ui.www_person.grid, {
	Add: function(){
		var app = new App({waitMsg: this.frmLoading});
		app.on({
			apploaded: function(){
				var f = new ui.www_person.item_form();
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('www_person')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.www_person.main.superclass.constructor.call(this, config);
		this.init();
	},
