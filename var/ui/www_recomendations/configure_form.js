ui.www_recomendations.configure_form = Ext.extend(Ext.form.FormPanel, {
	Load: function(data){
		var f = this.getForm();
	...
	constructor: function(config){
		...
		Ext.apply(this, {
			...
			//layout: 'fit',
			items: [
				{fieldLabel: this.lblLocale, hiddenName: 'lc', value: 'rus', xtype: 'combo', width: 50,
					store: new Ext.data.SimpleStore({fields: ['value', 'title'], data: [['rus', 'Русский'], ['eng', 'English']] }),
		...
		ui.www_recomendations.configure_form.superclass.constructor.call(this, config);
		this.on({
			scope: this
		})
	},
