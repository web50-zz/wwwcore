ui.www_recomendations.main = Ext.extend(ui.www_recomendations.grid, {
	Add: function(){
		var app = new App({waitMsg: this.frmLoading});
		app.on({
			apploaded: function(){
				var f = new ui.www_recomendations.item_form();
		...
		app.Load('www_recomendations', 'item_form');
	},
	Edit: function(){
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('www_recomendations')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.www_recomendations.main.superclass.constructor.call(this, config);
		this.init();
	},
