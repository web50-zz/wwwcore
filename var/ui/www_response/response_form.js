ui.www_response.response_form = Ext.extend(Ext.form.FormPanel, {
	formWidth: 640,
	formHeight: 400,
	...
	constructor: function(config){
		...
		ui.www_response.response_form.superclass.constructor.call(this, config);
		this.on({
