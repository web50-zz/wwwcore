ui.www_response.tree = Ext.extend(Ext.tree.TreePanel, {
	reload: function(id){
		if (id){
	...
	constructor: function(config){
		config = config || {};
		Ext.apply(this, {
			loader: new Ext.tree.TreeLoader({url: 'di/www_response/slice.json'}),
		...
		ui.www_response.tree.superclass.constructor.call(this, config);
		this.on({
