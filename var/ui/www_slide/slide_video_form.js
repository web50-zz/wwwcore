ui.www_slide.slide_video_form = Ext.extend(Ext.form.FormPanel, {
	Load: function(data){
		var f = this.getForm();
		if (data.id > 0){
			f.load({
	...
	constructor: function(config){
		...
		Ext.apply(this, {
			...
			items: [
				...
				{name: 'type', xtype: 'hidden', value: 3},
		...
		ui.www_slide.slide_video_form.superclass.constructor.call(this, config);
		this.on({
